<html>
<head>
<title>3.7 7th Transaction: Update Movie Prices</title>
<link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>

<div id="main">
<h1>3.7 7th Transaction: Update Movie Prices</h1>
<div id="login">
...
echo "<script type= 'text/javascript'>alert('Movie Prices updated successfully');</script>";
} else {
