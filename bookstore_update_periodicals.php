<html>
<head>
<title>3.7 7th Transaction: Update Periodical Prices</title>
<link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>

<div id="main">
<h1>3.7 7th Transaction: Update Periodical Prices</h1>
<div id="login">
...
echo "<script type= 'text/javascript'>alert('Periodicals Prices updated successfully');</script>";
} else {
